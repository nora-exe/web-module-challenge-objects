...
console.log(createMenuItem('Croissant', 5, 'Bakery'));
console.log(createMenuItem('Danish', 6, 'Bakery'));
console.log(createMenuItem('Muffin', 5, 'Bakery'));
...
reviews.push({name: 'Denice', rating: 2, feedback: "Liked the environment and menu, but the waitress's negative and dismissive attitude killed the vibe for the whole table. None of us are interested in returning when there are better dining options available nearby."});
console.log(reviews);
